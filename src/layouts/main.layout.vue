...
import { PeopleOutline, HomeOutline, LayersOutline, DocumentOutline } from '@vicons/ionicons5'
...
<template>
  <n-space vertical>
    <n-layout>
      <n-layout has-sider class="!bg-primary">
        <n-layout-sider
          bordered
          show-trigger
          collapse-mode="width"
        ...
        <n-layout style="min-height: 100vh" class="relative">
          <div class="sticky w-full inset-x-0 h-16 z-40 border-b">
            <div class="flex justify-end items-center h-16 px-5 bg-primary">
              <div>
