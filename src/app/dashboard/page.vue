<route lang="yaml">
  ...
  <template>
    <div>
      ...
      <div class="flex flex-col md:flex-row mx-auto gap-5 mb-10">
        <n-card v-for="item in laporan?.data">
          <n-card> {{ item.status }} : {{ item.count }} </n-card>
        </n-card>
      </div>
      <div class="flex flex-col mx-auto md:flex-row gap-5 mb-10">
        <n-select
      ...
      <div class="w-full whitespace-pre overflow-auto mx-auto">
