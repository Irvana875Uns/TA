...
const { mutate, isPending } = useHttpMutation('/jenis-laporan', {
  method: 'POST',
  queryOptions: {
...
<template>
  <div>
    <n-h2>
      Selamat Datang Halaman Tambah Jenis Pengaduan Sistem SIGAP
    </n-h2>
  </div>
  <div>
    <n-form @submit.prevent="onSubmit" :model="form" :rules="rules">
      <n-form-item label="Jenis Pengaduan" path="name">
